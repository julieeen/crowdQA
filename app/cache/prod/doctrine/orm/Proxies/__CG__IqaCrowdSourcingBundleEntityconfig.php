 ...
 */
class config extends \Iqa\CrowdSourcingBundle\Entity\config implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Iqa\\CrowdSourcingBundle\\Entity\\config' . "\0" . 'name', '' . "\0" . 'Iqa\\CrowdSourcingBundle\\Entity\\config' . "\0" . 'value');
        }
